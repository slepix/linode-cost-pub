/*
  # Complete Database Setup for CloudWatch Linode

  ## Summary
  Full schema setup including all tables, functions, RLS policies, and seed data.
  Modified to use private.jwt_config table instead of database configuration.

  ## Changes
  1. Creates all necessary extensions and roles
  2. Creates all application tables with proper RLS policies
  3. Creates helper functions for auth and org role checking
  4. Creates auth_register and auth_login functions
  5. Seeds built-in compliance rules and profiles
  6. Grants proper access to roles

  ## Security
  - All tables have RLS enabled with appropriate policies
  - JWT secret stored securely in private.jwt_config table
